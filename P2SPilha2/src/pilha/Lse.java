 ...
 * Classe..: Lse
 * Objetivo: CriaÃ§Ã£o e manutenÃ§Ã£o dos elementos na pilha simplesmente encadeada
 */
package pilha;
...
public class Lse
{
    ...
    // Objetivo: metodo para remover um elemento da última posição da pilha
    //           
    //
    ...
    public void consultar_conteudo_int(int conteudo)
    {
        ...
        if( aux == null ) {
        	...
        	System.out.println("O conteúdo ID =  " + conteudo + " não está presente na lista.");
    ...
    public void consultar_conteudo_str(String conteudo)
    {
        ...
        if(existe == false) {
        	System.out.println("O conteúdo STR =  " + conteudo + " não está presente na lista.");
        }
